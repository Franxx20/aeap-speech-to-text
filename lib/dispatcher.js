...
function processSegments(segments, isFinal) {
    ...
    //         // Check if the segment text is already processed
    //         if (!processedSegments.has(seg.text)) {
    //             text.push(seg.text);
    //             processedSegments.add(seg.text);
    //         }
    //     });
    // }

    if (isFinal) {
        // // Join the accumulated segments into a complete sentence

        console.log(segments)
        // const fullSentence = text.join(" ");
        // console.log("Complete sentence:", fullSentence);
        //
        // // Clear text and processed segments for the next sentence
        // text.length = 0;
