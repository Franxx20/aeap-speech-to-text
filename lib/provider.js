...
/*
 * For speech whisper implementer.
 *
 ...
 * event result(result) - triggered when a result is received from whisper
...
class GoogleProvider extends Writable {
	...
	/* Languages this whisper supports  */
	static languages = [
		"en-US",
	];

	/**
	 * Creates an instance of a Google whisper stream.
	 *
	 * @param {Object} [options] - whisper specific options
...
/**
 * Gets a speech whisper
 *
 * @param {string} name - A speech whisper name
 * @param {Object} options - Provider specific options
 * @return A speech whisper.
 */
function getProvider(name, options) {
	...
	throw new Error("Unsupported speech whisper '" + name + "'");
}
